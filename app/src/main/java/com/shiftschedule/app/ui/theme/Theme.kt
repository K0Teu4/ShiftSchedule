...
fun ShiftScheduleTheme(theme: String = "dark", content: @Composable () -> Unit) {
    val colorScheme = when (theme) {
        ...
        "dynamic" -> if (android.os.Build.VERSION.SDK_INT >= 31) {
            ...
            darkColorScheme(background = Color(0xFF0A0A0A), surface = Color(0xFF1A1A1A), primary = Color(0xFF5856D6), secondary = Color(0xFF34C759), onBackground = Color(0xFFFFFFFF), onSurface = Color(0xFFFFFFFF), onPrimary = Color(0xFFFFFFFF), error = Color(0xFFFF3B30))
        }
