...
class SettingsDataStore(private val context: Context) {
    ...
    val settingsFlow: Flow<AppSettings> = context.dataStore.data.map { preferences ->
        AppSettings(
            ...
            reminderTime = normalizeReminderTime(preferences[Keys.REMINDER_TIME]),
            ...
            theme = normalizeTheme(preferences[Keys.THEME]),
    ...
    private fun normalizeReminderTime(value: String?): String {
        val time = runCatching { LocalTime.parse(value ?: "08:00") }.getOrElse { LocalTime.of(8, 0) }
    ...
    suspend fun updateSettings(settings: AppSettings) {
        context.dataStore.edit { preferences ->
            ...
            preferences[Keys.REMINDER_TIME] = normalizeReminderTime(settings.reminderTime)
            ...
            preferences[Keys.THEME] = normalizeTheme(settings.theme)
